...
class PriceDataJobs:
    ...
    def __init__(self, job_configs, mongo_handler):
        """
        :param job_configs: List of job configs
    ...
    def job_runner(self, run_indefinitely=True):
        while run_indefinitely:
            try:
                ...
                print(f"An error occurred while running job: {str(e)}")
    ...
    def live_price_job(cls, job_config, mongo_handler):
        ...
        try:
            for asset in job_config['params'].keys():
                ...
                live_price_response = job_config['api_handler'].get_live_price(params["asset_name"],
                                                                               params["vs_currency"])
                ...
                if live_price_response is not None:
                    ...
                    if live_price_data is not None:
                        insert_result = mongo_handler.insert(collection=params["collection_name"],
